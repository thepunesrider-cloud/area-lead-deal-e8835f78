...
const MapWithRadius: React.FC<MapWithRadiusProps> = ({ 
  ...
  useEffect(() => {
    ...
    if (source) {
      const updatedCircle = createCircle([longitude, latitude], radiusKm);
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div className="absolute bottom-3 left-3 bg-card/90 backdrop-blur-sm px-3 py-1.5 rounded-full border border-border shadow-sm z-10">
